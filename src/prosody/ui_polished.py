...
class PolishedWaveformIndicator:
    ...
    def _create_waveform(self):
        ...
        radius = height // 2
        # Left circle
        self.canvas.create_oval(0, 0, height, height, 
                               fill='#1a1a1a', outline='#333333', width=1)
        # Right circle
        self.canvas.create_oval(width-height, 0, width, height, 
                               fill='#1a1a1a', outline='#333333', width=1)
        # Center rectangle
        self.canvas.create_rectangle(radius, 0, width-radius, height, 
                                    fill='#1a1a1a', outline='', width=0)
        # Top and bottom borders
        self.canvas.create_line(radius, 0, width-radius, 0, 
                               fill='#333333', width=1)
        self.canvas.create_line(radius, height-1, width-radius, height-1, 
                               fill='#333333', width=1)
    ...
    def _animate_waveform(self):
        ...
        for i in range(num_points):
            ...
            level = self.history[history_index] if history_index < len(self.history) else 0
